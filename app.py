...
us2s = 1000000
img_folder = "/home/pi/workspace/digtial_camera/images/"
...
class CameraMenu(object):
    ...
    def visual_dng(self,):
        ...
        if file_type == "dng":
            ...
            cv2.imwrite(f"{img_folder}/{file_stem}.jpeg", raw)
            self.load_images(init=True)            
    ...
    def visual_filters(self, ):
        ...
        for i,name in enumerate(self.filter_names):
            ...
            img = cv2.resize(img,(301,181))
            img = Image.fromarray(img)
            img = filter_func(img)
            img = np.ascontiguousarray(np.array(img)[:,:,::-1])
     
            img = QtGui.QImage(img, 301, 181, 3*301, QtGui.QImage.Format_RGB888)
    ...
    def load_images(self, init=True):
        ...
        for i, file in enumerate(img_paths, st):
            ...
            img = QtGui.QImage(file)
            img_large = img.scaled(320,int(320/4*3),aspectRatioMode=QtCore.Qt.KeepAspectRatio, transformMode = QtCore.Qt.FastTransformation)
    ...
    def setupUi(self,):
        ...
        self.MainImagelabel.setGeometry(QtCore.QRect(5, 5, 320, int(320/4*3)))
        ...
        self.widget_filter.setGeometry(QtCore.QRect(10, 210, 461, 101))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(10, 210, 461, 101))
        self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents_2")
        self.gridLayoutWidget_2 = QtWidgets.QWidget(self.scrollAreaWidgetContents_2)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 210, 461, 101))
...
class PreviewWindow(object):
    ...
    def get_file_idx(self, img_folder = "./images/"):
        if len(os.listdir(img_folder)) == 0:
            ...
            img_idx = max([int(x.split(".")[0]) for x in os.listdir(img_folder)]) + 1
        return img_idx   
